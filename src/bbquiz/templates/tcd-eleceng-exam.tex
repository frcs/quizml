...
%\newfontfamily\listingsfont[Scale=2]{Menlo}

%\listingsfont \fontsize{11}{13}\selectfont

%\fontseries{lc}
%\lstset{basicstyle=\linespread{1}\ttfamily\selectfont\footnotesize,
%% \lstset{frame=l,
%%   language=python,
...
\lstset{%
  frame=l,
  basicstyle=\linespread{1.1}\fontsize{11}{13}\selectfont,
